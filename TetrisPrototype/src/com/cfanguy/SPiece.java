...
public class SPiece implements Mover {
    ...
    public SPiece(java.awt.Color aColor,
...
public void setLocation (int x, int y) {
        ...
        _right.setLocation(x + 10, y +10);
        _left.setLocation(x, y + 10);
        _bottom.setLocation(x + 10, y + 20);
